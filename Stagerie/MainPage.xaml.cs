...
namespace Stagerie
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            Product product1 = new Product("0909123798213", "methilamine", "2", "stock", "cmd", "codeActe", "tva", "base", "prixTTC", "remise", "qte", "montant");
            Product product2 = new Product("0909123798213", "Nurofen", "8", "stock", "cmd", "codeActe", "tva", "base", "prixTTC", "remise", "qte", "montant");
            Product product3 = new Product("0909123798213", "doliprane", "3", "stock", "cmd", "codeActe", "tva", "base", "prixTTC", "remise", "qte", "montant");
            Product product4 = new Product("0909123798213", "Psntenol", "4", "stock", "cmd", "codeActe", "tva", "base", "prixTTC", "remise", "qte", "montant");
            Product product5 = new Product("0909123798213", "Dr.Mom", "5", "stock", "cmd", "codeActe", "tva", "base", "prixTTC", "remise", "qte", "montant");
            Product product6 = new Product("0909123798213", "Penthalgine", "6", "stock", "cmd", "codeActe", "tva", "base", "prixTTC", "remise", "qte", "montant");
            Product product7 = new Product("0909123798213", "Miramistin", "7", "stock", "cmd", "codeActe", "tva", "base", "prixTTC", "remise", "qte", "montant");
